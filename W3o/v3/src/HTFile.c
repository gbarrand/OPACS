...
extern "C"{
#endif
char* HTgeticonname(HTFormat, char *);
#ifdef __cplusplus
}
#endif
...
#include "HTMLNew.h"		/* For directory object building */
...
{ 
	...
	(char*)malloc(strlen(localname)+ 1 + strlen(HT_DIR_README_FILE) + 1);
...
PUBLIC HTBoolean HTEditable ARGS1 (CONST char *,filename)
{
#ifdef NO_GROUPS
...
*/
		...
		if (HTDirAccess == HT_DIR_SELECTIVE) {
			...
			(char*)malloc(strlen(localname)+ 1 +
