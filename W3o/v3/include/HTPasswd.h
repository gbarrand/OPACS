...
*/
HTBoolean HTAA_checkPassword PARAMS((CONST char * username,
                                       CONST char * password,
                                       CONST char * filename));
/*
...
**
*/
char *HTAA_encryptPasswd PARAMS((CONST char * password));
...
*/
HTBoolean HTAA_passwdMatch PARAMS((CONST char * password,
...
*/
int HTAAFile_readPasswdRec PARAMS((FILE * fp,
                                          char * out_username,
                                          char * out_password));
#ifdef __cplusplus
}
