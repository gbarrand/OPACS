...
*/
char* HTAA_composeAuth PARAMS((CONST char * hostname,
...
**                      NO, otherwise.
*/
HTBoolean HTAA_shouldRetryWithAuth PARAMS((char *     start_of_headers,
                                             int        length,
                                             int        soc));
...
*/
HTBoolean HTAA_TryWithAuth PARAMS((char *	enctype,
				     char *	entity,
				     char *	action));
