 ...
 */
char * HTLocalName PARAMS((CONST char * name));
 ...
 */
char * WWW_nameOfFile PARAMS((char * name));
 ...
 */
char * HTCacheFileName PARAMS((CONST char * name));
 ...
 */
void HTDirTitles PARAMS((        HTStructured *  target,        HTAnchor *      anchor));
...
HTFormat HTFileFormat PARAMS((
                char *    filename,
                HTAtom **       pEncoding,
                HTAtom *,
                int *compressed));
char * HTFileMimeType PARAMS((
                CONST char *    filename,
...
float HTFileValue PARAMS((                CONST char * filename));
...
HTBoolean HTEditable PARAMS((CONST char * filename));
 ...
 */
CONST char * HTFileSuffix PARAMS((                HTAtom* rep));
