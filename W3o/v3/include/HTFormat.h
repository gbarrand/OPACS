 ...
 */
void HTFileCopy PARAMS((
        FILE*                   fp,
        HTStream*               sink));
#if 0
void HTFileCopyToText PARAMS((
        FILE*                   fp,
        HText*                  text));
#endif
 ...
 */
void HTInitInput PARAMS((int file_number));
 ...
 */
extern HTBoolean HTOutputSource;     /* Flag: shortcut parser */
#endif
