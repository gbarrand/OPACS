...
HTChunk * HTChunkCreate PARAMS((int growby));
...
void HTChunkFree PARAMS((HTChunk * ch));
...
void HTChunkClear PARAMS((HTChunk * ch));
...
void HTChunkEnsure PARAMS((HTChunk * ch, int s));
 ...
 */
void HTChunkPutc PARAMS((HTChunk * ch, char c));
...
void HTChunkPuts PARAMS((HTChunk * ch, char *str));
...
void HTChunkTerminate PARAMS((HTChunk * ch));
#ifdef __cplusplus
}
#endif
