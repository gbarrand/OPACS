...
*/
void HTAA_setDefaultProtection PARAMS((CONST char *      cur_docname,
...
*/
void HTAA_setCurrentProtection PARAMS((CONST char *      cur_docname,
                                              CONST char *      prot_filename,
                                              CONST char *      eff_ids));
...
*/
void HTAA_clearProtections NOPARAMS;
/*
...
*/
HTAAProt *HTAA_getCurrentProtection NOPARAMS;
...
**              This must not be free()'d.
*/
HTAAProt *HTAA_getDefaultProtection NOPARAMS;
/*
