...
struct _HTParentAnchor {
  ...
  HTBoolean          isIndex;        /* Acceptance of a keyword search */
...
HTChildAnchor * HTAnchor_findChild  PARAMS(     (HTParentAnchor *parent,      CONST char *tag)  );
...
HTAnchor * HTAnchor_findAddress  PARAMS(     (CONST char * address)     );
...
HTBoolean HTAnchor_delete  PARAMS(     (HTParentAnchor *me)     );
...
void HTAnchor_makeLastChild  PARAMS(     (HTChildAnchor *me)     );

/*      Data access functions
**      ---------------------
*/

HTParentAnchor * HTAnchor_parent  PARAMS(     (HTAnchor *me)     );

void HTAnchor_setDocument  PARAMS(     (HTParentAnchor *me, HyperDoc *doc)     );

HyperDoc * HTAnchor_document  PARAMS(     (HTParentAnchor *me)     );

/* We don't want code to change an address after anchor creation... yet ?
void HTAnchor_setAddress  PARAMS(     (HTAnchor *me, char *addr)     );
*/

/*      Returns the full URI of the anchor, child or parent
**      as a malloc'd string to be freed by the caller.
*/
char * HTAnchor_address  PARAMS(     (HTAnchor *me)     );

void HTAnchor_setFormat  PARAMS(     (HTParentAnchor *me, HTFormat form)     );

HTFormat HTAnchor_format  PARAMS(     (HTParentAnchor *me)     );

void HTAnchor_setIndex  PARAMS(     (HTParentAnchor *me)     );

HTBoolean HTAnchor_isIndex  PARAMS(     (HTParentAnchor *me)     );

HTBoolean HTAnchor_hasChildren  PARAMS(     (HTParentAnchor *me)     );

/*      Title handling
*/
CONST char * HTAnchor_title  PARAMS(     (HTParentAnchor *me)     );

void HTAnchor_setTitle  PARAMS(     (HTParentAnchor *me, CONST char * title)     );

void HTAnchor_appendTitle  PARAMS(     (HTParentAnchor *me, CONST char * title)     );

/*      Link this Anchor to another given one
**      -------------------------------------
*/

HTBoolean HTAnchor_link  PARAMS(     (HTAnchor *source, HTAnchor *destination, HTLinkType *type)     );

/*      Manipulation of links
**      ---------------------
*/

HTAnchor * HTAnchor_followMainLink  PARAMS(     (HTAnchor *me)     );

HTAnchor * HTAnchor_followTypedLink  PARAMS(     (HTAnchor *me, HTLinkType *type)     );

HTBoolean HTAnchor_makeMainLink  PARAMS(     (HTAnchor *me, HTLink *movingLink)     );

/*      Read and write methods
**      ----------------------
*/
HTList * HTAnchor_methods PARAMS((HTParentAnchor *me));

/*      Protocol
**      --------
*/
void * HTAnchor_protocol PARAMS((HTParentAnchor * me));
void HTAnchor_setProtocol PARAMS((HTParentAnchor * me,                                        void* protocol));

/*      Physical address
**      ----------------
*/
char * HTAnchor_physical PARAMS((HTParentAnchor * me));
void HTAnchor_setPhysical PARAMS((HTParentAnchor * me,                                        char * protocol));
