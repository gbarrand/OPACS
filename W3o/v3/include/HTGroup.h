...
extern "C"{
#endif
GroupDef *HTAA_parseGroupDef PARAMS((FILE * fp));
/*
...
void HTAA_resolveGroupReferences PARAMS((GroupDef *     group_def,
...
GroupDefList *HTAA_readGroupFile PARAMS((CONST char * filename));
/*
...
void GroupDef_delete PARAMS((GroupDef * group_def));
/*
...
void HTAA_printGroupDef PARAMS((GroupDef * group_def));
/*
...
*/
HTAAFailReasonType HTAA_userAndInetInGroup PARAMS((GroupDef * group,
                                                          char *     username,
                                                          char *     ip_number,
                                                          char *     ip_name));
#ifdef __cplusplus
