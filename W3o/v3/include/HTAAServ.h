...
**
*/
int HTAA_checkAuthorization PARAMS((CONST char * url,
...
*/
char *HTAA_statusMessage NOPARAMS;
/*
...
*/
char *HTAA_composeAuthHeaders NOPARAMS;
/*
...
**
*/
void HTAA_startLogging PARAMS((FILE * fp));
#ifdef __cplusplus
}
#endif
