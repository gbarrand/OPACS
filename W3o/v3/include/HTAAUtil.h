...
#include "HTUtils.h"            /* HTBoolean, PARAMS, ARGS */
#include "HTList.h"
...
*/
HTAAScheme HTAAScheme_enum PARAMS((CONST char* name));
...
**                      "none", "basic", "pubkey", ...
*/
char *HTAAScheme_name PARAMS((HTAAScheme scheme));
...
**                      to the given name.
*/
HTAAMethod HTAAMethod_enum PARAMS((CONST char * name));
...
**                      "GET", "PUT", ...
*/
char *HTAAMethod_name PARAMS((HTAAMethod method));
...
**                      NO, if not found.
*/
HTBoolean HTAAMethod_inList PARAMS((HTAAMethod        method,
                                     HTList *           list));
/*
...
**                      NO, otherwise.
*/
HTBoolean HTAA_templateMatch PARAMS((CONST char * template_,
                                       CONST char * filename));
...
*/
char *HTAA_makeProtectionTemplate PARAMS((CONST char * docname));
/*
...
**              "1" for the first, etc.
*/
HTList *HTAA_parseArgList PARAMS((char * str));
...
*/
void HTAA_setupReader PARAMS((char *     start_of_headers,
                                     int        length,
                                     int        soc));
...
**
*/
char *HTAA_getUnfoldedLine NOPARAMS;
#ifdef __cplusplus
}
#endif
