...
typedef void (*pointerTrackProc)(HTMLWidget,char*);
typedef ImageInfo *(*resolveDelayedImageProc)(HTMLWidget,char*);
typedef ImageInfo *(*resolveImageProc)(HTMLWidget,char*,int);
typedef int (*visitTestProc)(HTMLWidget,char*);


#ifdef __cplusplus /*Barrand*/
extern "C"{        /*Barrand*/
#endif             /*Barrand*/
extern void   GetMailtoKludgeInfo     (char**,char**);
extern char*  HTMLGetText             (Widget w, int pretty, char *url);
extern char*  HTMLGetTextAndSelection (Widget w, char **startp, char **endp,char **insertp);
...
extern void HTMLSetText (Widget w, char *text, char *header_text,char *footer_text, int element_id,char *target_anchor, void *ptr);
extern int HTMLSearchText (Widget w, char *pattern,ElementRef *m_start, ElementRef *m_end, int backward, int caseless);
#ifdef __cplusplus
}
#endif
