...
/* end amb */
        ...
        visitTestProc 		previously_visited_test;
        resolveImageProc	resolveImage;
        resolveDelayedImageProc	resolveDelayedImage;
        
        pointerTrackProc        pointer_motion_callback;
