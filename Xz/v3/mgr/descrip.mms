...
#/* +---------------------- Copyright notice -------------------------------+ */
#
# The environment variable XZROOT must be defined with something like :
#     VMS$ define/nolog/translation=(concealed) XZROOT   <disk>:[<root>.Xz.v3.]
...
This_needed :
	@ if f$trnlnm ("XZROOT")  .eqs. "" then write sys$output "XZROOT not set"
