...
static void compress_term (void);
...
/*.........................................................................*/
  ...
  hash_code   = (code_int FAR *) CMemoryAllocateBlock (HSIZE * sizeof(code_int));
  hash_prefix = (code_int FAR *) CMemoryAllocateBlock (HSIZE * sizeof(code_int));
  hash_suffix = (UINT8 FAR *)    CMemoryAllocateBlock (HSIZE * sizeof(UINT8));
  /*
...
/***************************************************************************/
void CJPEG_PutColormapInGIF_Stream (
 int num_colors
,JSAMPARRAY colormap
)
/***************************************************************************/
...
/***************************************************************************/
void CJPEG_PutImageInGIF_Stream (
 long a_width
,int num_rows
...
/*.........................................................................*/
  ...
  if (ferror(Class.output_file)!=0) ReportError("CJPEG_EndGIF_Stream",CErrorIO);

  /* Free space */
  CMemoryFreeBlock (hash_code);
  CMemoryFreeBlock (hash_prefix);
  CMemoryFreeBlock (hash_suffix);
}
...
/* flush any accumulated data */
{
  if (bytesinpkt > 0) {		/* never write zero-length packet */
    ...
    if (JFWRITE(Class.output_file, packetbuf, bytesinpkt) != (size_t) bytesinpkt) ReportError("CJPEG_EndGIF_Stream",CErrorIO);
    bytesinpkt = 0;
  }
}
...
/* If colormap==NULL, synthesize a gray-scale colormap */
{
  ...
  if (num_colors > 256) ReportError ("emit_header",CErrorValue);
...
{
/*.........................................................................*/
  CErrorHandle ("Co","CJPEG",a_name,a_code);
}
