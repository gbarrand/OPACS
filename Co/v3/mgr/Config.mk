...
"CXXLD         = cxx" \
"CXXLDFLAGS    = -ptr $${OREPOSITORY}" \
"CXXLDEND      = -lots -lSM -lICE -ldnet_stub" \
"APP_CXXFLAGS  = -define_templates -DSOLVE_TEMPLATES" \
"F77           = f77" \
"F77FLAGS      = -w" \
"F77LD         = f77" \
"X11_CPPFLAGS  = " \
...
"CXX           = CC" \
"CXXFLAGS      = +a1 +Z -pta -ptr$${OREPOSITORY} -O" \
"CXXLD         = CC" \
...
"F77LD         = fort77" \
"X11_CPPFLAGS  = " \
"Xext_CPPFLAGS = -I/usr/include/X11R6/X11/extensions" \
...
"CXXLD         = CC" \
"CXXLDFLAGS    = +a1 +Z -pts -ptr$${OREPOSITORY} -O" \
"CXXLDEND      = " \
"APP_CXXFLAGS  = -DSOLVE_TEMPLATES" \
"F77           = f77" \
"F77FLAGS      = -w +ppu" \
...
# -D_POSIX_C_SOURCE to compile OBatchU.ic.:wq
# In libXm, add libXaw for XoCamera, XoPlotter popup that do not work
# with Lesstif and then are implemented with Xaw. 
# If you have a true Motif remove -DHAS_LESSTIF in Xm_CPPFLAGS 
# and -lXaw in libXm.
Linux : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = so" \
"so            = so" \
"CC            = gcc" \
"CFLAGS        = -ansi -DUNIX -DHAS_DLD -D_POSIX_C_SOURCE -O" \
"CCLD          = gcc" \
"CCLDFLAGS     = " \
"CCLDEND       = " \
"CXX           = g++" \
"CXXFLAGS      = -pipe -fno-for-scope -O" \
"CXXLD         = g++" \
"CXXLDFLAGS    = " \
"CXXLDEND      = " \
"F77           = g77" \
...
"Xt_CPPFLAGS   = " \
"Xaw_CPPFLAGS  = " \
"Xm_CPPFLAGS   = -I/usr/X11R6/include -DHAS_LESSTIF" \
"libc          = -lc" \
"libm          = -lm" \
"libf77        = -lg2c -lnsl" \
...
"CCLDEND       = " \
"CXX           = g++" \
"CXXFLAGS      = -Wall -ansi -pipe -fno-for-scope -O" \
"CXXLD         = g++" \
"CXXLDFLAGS    = " \
"CXXLDEND      = " \
"F77           = f77" \
...
#Darwin wl-72106.lal.in2p3.fr 7.9.0 Darwin Kernel Version 7.9.0: Wed Mar 30 20:11:17 PST 2005; root:xnu/xnu-517.12.7.obj~1/RELEASE_PPC  Power Macintosh powerpc
# Xm is under /sw installed by Fink.
Darwin : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = dylib" \
"so            = dylib" \
...
"F77LD         = g77" \
"X11_CPPFLAGS  = " \
"Xext_CPPFLAGS = -I/usr/X11R6/include/X11/extensions" \
"Xmu_CPPFLAGS  = -I/usr/X11R6/include/X11" \
"Xt_CPPFLAGS   = " \
"Xaw_CPPFLAGS  = " \
"Xm_CPPFLAGS   = -I/sw/include" \
"libc          = -lc" \
"libm          = -lm" \
"libf77        = -lg2c -lnsl" \
...
# Take care of linking with libraries constructed with gcc. 
IRIX : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = so" \
"so            = so" \
...
# IRIX64 marelle 6.2 03131016 IP19
IRIX64 : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = so" \
"so            = so" \
...
# Unable to compile HoF77.c even with setting TMPDIR !
LynxOS-VGPW2 : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = a" \
"so            = so" \
"CC            = gcc" \
...
# LynxOS virgo_control1 2.5.1 092297-D PowerPC :
LynxOS-PowerPC : This_needed
	@CONFIG=$@;export CONFIG;MAKEFLAGS='';export MAKEFLAGS;$(MAKE) -f This.mk $(t) $(target)  \
"a_or_so       = a" \
"so            = so" \
"CC            = gcc" \
"CFLAGS        = -ansi -DUNIX -DHAS_DLD" \
"CCLD          = gcc" \
"CCLDFLAGS     = " \
"CCLDEND       = -lnetinet -lrpc" \
"F77           = f77" \
"F77FLAGS      = " \
"F77LD         = f77" \
"X11_CPPFLAGS  = " \
