 ...
 *
 * KUIP header: 950303      Generation date: Thu Oct  3 16:03:13 1996
 *
 * Input file: ../src/kwodef.txt
 */
...
#ifdef F77_LCASE
#  define kwodef_ kwodef
#  define kwoquit_ kwoquit
#  define kwoosh_ kwoosh
#  define kwofile_ kwofile
#endif
...
#ifdef IBM370
#  pragma linkage(KWODEF,FORTRAN)
#  pragma linkage(KWOQUIT,FORTRAN)
#  pragma linkage(KWOOSH,FORTRAN)
#  pragma linkage(KWOFILE,FORTRAN)
#endif

extern void kwodef_();
extern void kwoquit_();
extern void kwoosh_();
extern void kwofile_();

void kwodef_()
{

static KmCommand _Wo_quit = {  (KmCommand*)0, "/Wo/quit", "quit", 0, 1, 0, 0,
 (KmParameter**)0, 0, 0, kwoquit_, (IntFunc*)0, (SUBROUTINE*)0, (pCharFunc*)0,
 0, (char**)0, 0, (char**)0, 0, (char**)0, 0, (char**)0, (char*)0, (int*)0 };

static KmParameter _Wo_osh_name = { "name", 4, "osh command", "#nil",
 (char*)0, 20, 0, (char**)0, 0, (char**)0, (KmParFlag)0, KmTYPE_CHAR, 
 (void*)0 };
static KmParameter *_Wo_osh_parameters[] = { &_Wo_osh_name };
static KmCommand _Wo_osh = { &_Wo_quit, "/Wo/osh", "osh", 0, 1, 1, 1,
 _Wo_osh_parameters, 0, 0, kwoosh_, (IntFunc*)0, (SUBROUTINE*)0,
 (pCharFunc*)0, 0, (char**)0, 0, (char**)0, 0, (char**)0, 0, (char**)0,
 (char*)0, (int*)0 };

static KmParameter _Wo_file_name = { "name", 4, "File name", "upaw.odb",
 (char*)0, 20, 0, (char**)0, 0, (char**)0, (KmParFlag)0, KmTYPE_CHAR, 
 (void*)0 };
static KmParameter *_Wo_file_parameters[] = { &_Wo_file_name };
static KmCommand _Wo_file = { &_Wo_osh, "/Wo/file", "file", 0, 1, 1, 1,
 _Wo_file_parameters, 0, 0, kwofile_, (IntFunc*)0, (SUBROUTINE*)0,
 (pCharFunc*)0, 0, (char**)0, 0, (char**)0, 0, (char**)0, 0, (char**)0,
 (char*)0, (int*)0 };

static KmMenu _Wo = {  (KmMenu*)0,  (KmMenu*)0, "/Wo", "Wo", 1, &_Wo_file, 0,
